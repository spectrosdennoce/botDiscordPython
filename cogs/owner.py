...
class owner(commands.Cog, name="owner"):
    ...
    async def say(self, context, *, args):
        """
        Vous pouvez faire parler le bot
    ...
    async def embed(self, context, *, args):
        """
        Vous pouvez faire parler le bot mais dans un embed
    ...
    async def blacklist(self, context):
        """
        Affiche les Id des personnes qui ont le droit et qui n'ont pas le droit d'utiliser le bot
    ...
    async def blacklist_add(self, context, member: discord.Member):
        """
        Ajouter un utilisateur a la Blacklist
    ...
    async def blacklist_remove(self, context, member: discord.Member):
        """
        Enlever un utilisateur de la blacklist
